...
import { defaultValueForm } from "constants/formInitialValues";
    ...
    <>
      <Card bordered={false} style={{ width: "100%", marginBottom: "5px" }}>
        <div className="mx-auto max-w-580-px">
          <div>
            On the template page fill any information that may be relevant across all stages, such information is found
            in completion procedures etc. Common information that can be normally filled out in the template is the
            following:
          </div>
        </div>
      </Card>
          ...
          <Tabs onChange={callback} type="card">
            <TabPane tab="Parameter bounds" key="1">
              <Divider orientation="left" plain>
                <strong>Parameter bounds</strong>
              </Divider>
              <Row gutter={24}>
                <Col span={10}>
                  <Form.Item
            ...
            <TabPane tab="Fluid properties" key="3">
              <Divider orientation="left" plain>
                <strong>Fluid properties</strong>
              </Divider>
              <Row>
                <Col span={10}>
                  <Form.Item
            ...
            <TabPane tab="Special defaults" key="7">
              <Divider orientation="left" plain>
                <strong>Special defaults</strong> (do not change unless the consequences are understood)
              </Divider>
              ...
              <Divider orientation="left" plain>
                <strong>Do not change the following</strong>
              </Divider>
              <Row>
                <Col span={10}>
                  <Form.Item
