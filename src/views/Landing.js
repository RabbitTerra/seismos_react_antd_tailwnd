              ...
              <div className="w-full px-4 ml-auto mr-auto text-center lg:w-6/12">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-blueGray-200">
                    This is a simple example of a Landing Page you can build using Notus React. It features multiple CSS
              ...
              <div className="w-full px-4 mb-12 md:w-6/12 lg:w-3/12 lg:mb-0">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm font-semibold uppercase text-blueGray-400">Web Developer</p>
                    <div className="mt-6">
                      <button
              ...
              <div className="w-full px-4 mb-12 md:w-6/12 lg:w-3/12 lg:mb-0">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm font-semibold uppercase text-blueGray-400">Marketing Specialist</p>
                    <div className="mt-6">
                      <button
              ...
              <div className="w-full px-4 mb-12 md:w-6/12 lg:w-3/12 lg:mb-0">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm font-semibold uppercase text-blueGray-400">UI/UX Designer</p>
                    <div className="mt-6">
                      <button
                        className="w-8 h-8 mb-1 mr-1 text-white bg-red-600 rounded-full outline-none focus:outline-none"
                        type="button"
              ...
              <div className="w-full px-4 mb-12 md:w-6/12 lg:w-3/12 lg:mb-0">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm font-semibold uppercase text-blueGray-400">Founder and CEO</p>
                    <div className="mt-6">
                      <button
                        className="w-8 h-8 mb-1 mr-1 text-white bg-pink-500 rounded-full outline-none focus:outline-none"
                        type="button"
        ...
        <section className="relative block pb-20 bg-blueGray-800">
          ...
          >
            <svg
              ...
              y="0"
            >
              <polygon className="fill-current text-blueGray-800" points="2560 0 2560 100 0 100"></polygon>
            </svg>
          </div>
                ...
                <div className="relative flex flex-col w-full min-w-0 mb-6 break-words rounded-lg shadow-lg bg-blueGray-200">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mt-8 mb-3">
                      <label className="block mb-2 text-xs font-bold uppercase text-blueGray-600" htmlFor="full-name">
                        Full Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="relative w-full mb-3">
                      <label className="block mb-2 text-xs font-bold uppercase text-blueGray-600" htmlFor="email">
                        Email
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="relative w-full mb-3">
                      <label className="block mb-2 text-xs font-bold uppercase text-blueGray-600" htmlFor="message">
                        Message
                      </label>
                      <textarea
                        rows="4"
