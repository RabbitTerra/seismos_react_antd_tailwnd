          ...
          <div className="w-full px-4 md:w-8/12 lg:w-6/12 xl:w-6/12">
            <div className="pt-32 sm:pt-0">
              ...
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                ...
                <a href="https://tailwindcss.com/?ref=seismos" className="text-blueGray-600" target="_blank">
                  Tailwind CSS
                </a>
              ...
              <div className="mt-12">
                <a
                  ...
                  target="_blank"
                  className="px-6 py-4 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear rounded shadow outline-none get-started focus:outline-none bg-lightBlue-500 active:bg-lightBlue-600 hover:shadow-lg"
                >
                  Get started
                </a>
                <a
                  href="https://github.com/seismosofficial/notus-react?ref=nr-index"
      ...
      <section className="relative pb-40 mt-48 md:mt-40 bg-blueGray-100">
        ...
        >
          <svg
            ...
            y="0"
          >
            <polygon className="fill-current text-blueGray-100" points="2560 0 2560 100 0 100"></polygon>
          </svg>
        </div>
            ...
            <div className="w-10/12 px-12 ml-auto mr-auto -mt-32 md:w-6/12 lg:w-4/12 md:px-4">
              <div className="relative flex flex-col w-full min-w-0 mb-6 break-words bg-white rounded-lg shadow-lg bg-lightBlue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  >
                    <polygon points="-30,95 583,95 583,65" className="fill-current text-lightBlue-500"></polygon>
                  </svg>
                ...
                <div className="w-full px-4 md:w-6/12">
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="flex-auto px-4 py-5">
                      ...
                      <h6 className="mb-1 text-xl font-semibold">JavaScript Components</h6>
                      <p className="mb-4 text-blueGray-500">
        ...
        <div className="container pb-20 mx-auto overflow-hidden">
          <div className="flex flex-wrap items-center">
            <div className="w-full px-12 mt-48 ml-auto mr-auto md:w-4/12 md:px-4">
              ...
              <h3 className="mb-2 text-3xl font-semibold leading-normal">CSS Components</h3>
              ...
              >
                View All <i className="ml-1 leading-relaxed fa fa-angle-double-right"></i>
              </a>
            </div>
          ...
          <div className="flex flex-wrap items-center pt-32">
                  ...
                  >
                    <div className="p-8 text-center bg-red-600 rounded-lg shadow-lg">
                      <img
                        ...
                        src="https://raw.githubusercontent.com/seismosofficial/public-assets/master/logos/svelte.jpg"
                      />
                      <p className="mt-4 text-lg font-semibold text-white">Svelte</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="p-8 mt-8 text-center rounded-lg shadow-lg bg-lightBlue-500">
                      <img
                        alt="..."
                        className="w-16 max-w-full p-2 mx-auto bg-white rounded-full shadow-md"
                        src="https://raw.githubusercontent.com/seismosofficial/public-assets/master/logos/react.jpg"
                      />
                      <p className="mt-4 text-lg font-semibold text-white">ReactJS</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="p-8 mt-8 text-center rounded-lg shadow-lg bg-blueGray-700">
                      <img
                        alt="..."
                        className="w-16 max-w-full p-2 mx-auto bg-white rounded-full shadow-md"
                        src="https://raw.githubusercontent.com/seismosofficial/public-assets/master/logos/nextjs.jpg"
                      />
                      <p className="mt-4 text-lg font-semibold text-white">NextJS</p>
                    </div>
                  </a>
                </div>
                  ...
                  >
                    <div className="p-8 text-center bg-yellow-500 rounded-lg shadow-lg">
                      <img
                        alt="..."
                        className="w-16 max-w-full p-2 mx-auto bg-white rounded-full shadow-md"
                        src="https://raw.githubusercontent.com/seismosofficial/public-assets/master/logos/js.png"
                      />
                  ...
                  >
                    <div className="p-8 mt-8 text-center bg-red-700 rounded-lg shadow-lg">
                      <img
                        alt="..."
                        className="w-16 max-w-full p-2 mx-auto bg-white rounded-full shadow-md"
                        src="https://raw.githubusercontent.com/seismosofficial/public-assets/master/logos/angular.jpg"
                      />
                      <p className="mt-4 text-lg font-semibold text-white">Angular</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="p-8 mt-8 text-center rounded-lg shadow-lg bg-emerald-500">
                      <img
                        alt="..."
                        className="w-16 max-w-full p-2 mx-auto bg-white rounded-full shadow-md"
                        src="https://raw.githubusercontent.com/seismosofficial/public-assets/master/logos/vue.jpg"
                      />
                      <p className="mt-4 text-lg font-semibold text-white">Vue.js</p>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div className="w-full px-12 mt-48 ml-auto mr-auto md:w-4/12 md:px-4">
              ...
              <h3 className="mb-2 text-3xl font-semibold leading-normal">Javascript Components</h3>
              <p className="mt-4 mb-4 text-lg font-light leading-relaxed text-blueGray-600">
        ...
        <div className="flex flex-wrap justify-center mt-24 text-center">
          <div className="w-full px-12 md:w-6/12 md:px-4">
            ...
            <p className="mt-4 mb-4 text-lg leading-relaxed text-blueGray-500">
              Notus React is a completly new product built using our past experience in web templates. Take the examples
              we made for you and start playing with them.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="w-full px-4 -mt-24 lg:w-12/12">
              <div className="flex flex-wrap">
                <div className="w-full px-4 lg:w-4/12">
                  <h5 className="pb-4 text-xl font-semibold text-center">Login Page</h5>
                  <Link to="/auth/login">
                ...
                <div className="w-full px-4 lg:w-4/12">
                  <h5 className="pb-4 text-xl font-semibold text-center">Profile Page</h5>
                  <Link to="/profile">
                    <div className="relative flex flex-col w-full min-w-0 mb-6 break-words transition-all duration-150 ease-linear bg-white rounded-lg shadow-lg hover:-mt-4">
                      <img
                        alt="..."
                ...
                <div className="w-full px-4 lg:w-4/12">
                  <h5 className="pb-4 text-xl font-semibold text-center">Landing Page</h5>
                  <Link to="/landing">
                    <div className="relative flex flex-col w-full min-w-0 mb-6 break-words transition-all duration-150 ease-linear bg-white rounded-lg shadow-lg hover:-mt-4">
                      <img
                        alt="..."
        ...
        <div className="container pb-64 mx-auto">
          <div className="flex flex-wrap justify-center">
            <div className="w-full px-12 ml-auto mr-auto md:w-5/12 md:px-4 md:mt-64">
              ...
              <h3 className="mb-2 text-3xl font-semibold leading-normal text-white">Open Source</h3>
              <p className="mt-4 mb-4 text-lg font-light leading-relaxed text-blueGray-400">
                Since{" "}
                <a href="https://tailwindcss.com/?ref=seismos" className="text-blueGray-300" target="_blank">
                  Tailwind CSS
                </a>{" "}
        ...
        <div className="container mx-auto">
          <div className="relative z-10 flex flex-wrap justify-center px-12 py-16 -mt-64 bg-white rounded-lg shadow-xl">
            <div className="w-full text-center lg:w-8/12">
              ...
              <h3 className="text-3xl font-semibold">Do you love this Starter Kit?</h3>
              <p className="mt-4 mb-4 text-lg leading-relaxed text-blueGray-500">
