          ...
          >
            <ul className="flex flex-col mr-auto list-none lg:flex-row">
              <li className="flex items-center">
                ...
                >
                  <i className="mr-2 text-lg text-blueGray-400 far fa-file-alt leading-lg" /> Docs
                </a>
              </li>
            </ul>
            <ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
              ...
              <li className="flex items-center">
                <button
                  className="px-4 py-2 mb-3 ml-3 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear rounded shadow outline-none bg-lightBlue-500 active:bg-lightBlue-600 hover:shadow-lg focus:outline-none lg:mr-1 lg:mb-0"
                  type="button"
                >
