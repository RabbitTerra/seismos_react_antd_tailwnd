          ...
          >
            ...
            <ul className="flex flex-col list-none md:flex-col md:min-w-full md:mb-4">
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/react/colors/notus"
                  target="_blank"
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/react/alerts/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/angular/overview/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/js/overview/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/nextjs/overview/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/react/overview/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
                  <i className="mr-2 text-base fab fa-react text-blueGray-300"></i>
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/svelte/overview/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.seismos.com/learning-lab/tailwind/vue/overview/notus"
                  target="_blank"
                  className="block mb-4 text-sm font-semibold no-underline text-blueGray-700 hover:text-blueGray-500"
                >
